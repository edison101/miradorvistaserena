...
export default function MenuSection() {
  ...
  const drinkItems = [
    ...
    { id: 'jugo-agua', name: t('drinks.naturalJuiceWater'), price: 12000, category: t('menu.coldDrinks') },
    { id: 'jugo-leche', name: t('drinks.naturalJuiceMilk'), price: 14000, category: t('menu.coldDrinks') },
